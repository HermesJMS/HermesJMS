...
public class WatchTable extends HierarchicalTable
{
     ...
     * Rows are:
     * 
     * Color.RED if an alert level has been breached. Color.ORANGE if an
     * exception has occured gathering the data
     */
    public Component prepareRenderer(TableCellRenderer renderer, int y, int x)
    {
        ...
        /*
         * I don't understand this bit - unless I get the actual renderer when
         * the component is an ExpandablePanel the first column shades
         * incorrectly.
         */
