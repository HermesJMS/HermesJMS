         ...
         public void contentsChanged(ListDataEvent arg0)
         {
            ...
            try
            {
               if (propertyTableModel != null)
               {
                  ...
                  bean = (ConnectionFactory) ReflectUtils.createConnectionFactory(classLoader.loadClass(className)); 
   ...
   public void setFactoryConfig(final HermesConfig hConfig, FactoryConfig newFactory)
   {
      ...
      catch (Throwable e)
      {
         ...
         HermesBrowser.getBrowser().showErrorDialog(
               "Cannot find class " + factoryConfig.getProvider().getClassName() + " in loader " + factoryConfig.getClasspathId());
      }
