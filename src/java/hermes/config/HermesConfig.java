 ...
 *       &lt;attribute name="deleteBatch" type="{http://www.w3.org/2001/XMLSchema}int" default="50" />
...
public class HermesConfig {
    ...
    @XmlAttribute(name = "lastEditedByUser")
    protected String lastEditedByUser;
    @XmlAttribute(name = "lastEditedByHermesVersion")
    ...
    @XmlAttribute(name = "auditDirectory")
    protected String auditDirectory;
    @XmlAttribute(name = "messageFilesDir")
    protected String messageFilesDir;
    @XmlAttribute(name = "maxMessagesInBrowserPane")
    protected Integer maxMessagesInBrowserPane;
    @XmlAttribute(name = "copyJMSProviderProperties")
    protected Boolean copyJMSProviderProperties;
    @XmlAttribute(name = "copyJMSCorrelationID")
    protected Boolean copyJMSCorrelationID;
    @XmlAttribute(name = "copyJMSType")
    protected Boolean copyJMSType;
    @XmlAttribute(name = "copyJMSExpiration")
    protected Boolean copyJMSExpiration;
    @XmlAttribute(name = "copyJMSReplyTo")
    protected Boolean copyJMSReplyTo;
    @XmlAttribute(name = "copyJMSPriority")
    protected Boolean copyJMSPriority;
    @XmlAttribute(name = "embeddedMessageInBrowsePane")
    protected Boolean embeddedMessageInBrowsePane;
    @XmlAttribute(name = "displayFactoryAdmin")
    protected Boolean displayFactoryAdmin;
    @XmlAttribute(name = "maxColumnsInStatisticsTable")
    protected Integer maxColumnsInStatisticsTable;
    @XmlAttribute(name = "autoBrowseRefreshRate")
    protected Integer autoBrowseRefreshRate;
    @XmlAttribute(name = "correctDropSemantics")
    protected Boolean correctDropSemantics;
    @XmlAttribute(name = "selectorImpl")
    protected String selectorImpl;
    @XmlAttribute(name = "queueBrowseConsumerTimeout")
    protected Long queueBrowseConsumerTimeout;
    @XmlAttribute(name = "enableJython")
    protected Boolean enableJython;
    @XmlAttribute(name = "lookAndFeel")
    protected String lookAndFeel;
    @XmlAttribute(name = "messageStoreSession")
    protected String messageStoreSession;
    @XmlAttribute(name = "scrollMessagesDuringBrowse")
    protected Boolean scrollMessagesDuringBrowse;
    @XmlAttribute(name = "deliveryModePersistent")
    protected Boolean deliveryModePersistent;
    @XmlAttribute(name = "base64EncodeMessages")
    protected Boolean base64EncodeMessages;
    @XmlAttribute(name = "messageStoreMessageFactory")
    protected String messageStoreMessageFactory;
    @XmlAttribute(name = "deleteBatch")
    protected Integer deleteBatch;
    @XmlAttribute(name = "showDestinationsInMessageStore")
    ...
    /**
     * Gets the value of the deleteBatch property.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
    ...
    /**
     * Sets the value of the deleteBatch property.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setDeleteBatch(Integer value) {
        this.deleteBatch = value;
    }
